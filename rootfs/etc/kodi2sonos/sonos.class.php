...
class SonosPHPController
{
  ...
  /**
	...
	*/
	...
	{
		$url = '/MediaRenderer/ContentDirectory/Control';
		$action = 'GetQueue';
		$service = 'urn:schemas-upnp-org:service:ContentDirectory:1#Browse';
		$args = '<InstanceID>0</InstanceID><Channel>Master</Channel>';
		$filter = 'queue';
		return $this->Upnp($url,$service,$action);
	}
	...
	*/
    ...
    $data["Cover"] = $this->Filter($xml,"upnp:albumArtURI");
		return $data;
	}
